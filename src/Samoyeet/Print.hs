...
instance Print Arg where
  prt i e = case e of
    Arg stype id -> prPrec i 0 (concatD [prt 0 stype, prt 0 id])
    RefArg stype id -> prPrec i 0 (concatD [prt 0 stype, doc (showString "&"), prt 0 id])
  prtList _ [] = (concatD [])
...
instance Print Stmt where
  prt i e = case e of
    ...
    Decl stype items -> prPrec i 0 (concatD [prt 0 stype, prt 0 items, doc (showString ";")])
    ...
    CondElse expr stmt1 stmt2 -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 stmt1, doc (showString "else"), prt 0 stmt2, doc (showString "endif")])
...
instance Print SType where
  ...
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
instance Print MaybeRefType where
  prt i e = case e of
    NoRef stype -> prPrec i 0 (concatD [prt 0 stype])
    JustRef stype -> prPrec i 0 (concatD [prt 0 stype, doc (showString "&")])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
