...
instance Print (Arg a) where
  prt i e = case e of
    Arg _ stype id -> prPrec i 0 (concatD [prt 0 stype, prt 0 id])
    RefArg _ stype id -> prPrec i 0 (concatD [prt 0 stype, doc (showString "&"), prt 0 id])
  prtList _ [] = (concatD [])
...
instance Print (Stmt a) where
  prt i e = case e of
    ...
    Decl _ stype items -> prPrec i 0 (concatD [prt 0 stype, prt 0 items, doc (showString ";")])
    ...
    Print _ expr -> prPrec i 0 (concatD [doc (showString "yeet"), prt 0 expr, doc (showString ";")])
    SFnDef _ stype id args block -> prPrec i 0 (concatD [prt 0 stype, prt 0 id, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
  prtList _ [] = (concatD [])
...
instance Print (SType a) where
  prt i e = case e of
    ...
    Fun _ stype maybereftypes -> prPrec i 0 (concatD [doc (showString "Fun"), doc (showString "<"), prt 0 stype, doc (showString "("), prt 0 maybereftypes, doc (showString ")"), doc (showString ">")])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
instance Print (MaybeRefType a) where
  prt i e = case e of
    NoRef _ stype -> prPrec i 0 (concatD [prt 0 stype])
    JustRef _ stype -> prPrec i 0 (concatD [prt 0 stype, doc (showString "&")])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
instance Print (Expr a) where
  prt i e = case e of
    ...
    ELambda _ args stype block -> prPrec i 0 (concatD [doc (showString "[]"), doc (showString "("), prt 0 args, doc (showString ")"), doc (showString ":"), prt 0 stype, prt 0 block])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
